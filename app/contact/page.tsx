...
export const metadata: Metadata = {
  ...
  description:
    "Contact RR Nursery and Landscaping in Thoothukudi, Tamil Nadu for a free consultation, landscape design quote, or plant enquiry. Serving South Tamil Nadu — Thoothukudi, Tirunelveli, Nagercoil & more.",
  keywords: [
...
const contactDetails = [
  { icon: MapPin, title: "Visit Us",       lines: ["[Your Street Address]", "Thoothukudi, Tamil Nadu 628001"] },
  { icon: Phone,  title: "Call Us",        lines: ["+91-[YOUR-PHONE]", "Mon–Sat: 8 AM – 6 PM"] },
  { icon: Mail,   title: "Email Us",       lines: ["info@rrnursery.in", "We reply within 24 hours"] },
  { icon: Clock,  title: "Opening Hours",  lines: ["Mon–Fri: 8 AM – 6 PM", "Saturday: 9 AM – 4 PM", "Sunday: Closed"] },
];
      ...
      <section className="bg-gradient-to-br from-forest-800 to-forest-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-forest-100 text-lg max-w-2xl mx-auto">
            Have a question, need a quote, or just want to talk plants? We would love to hear from you. Serving Thoothukudi and all of South Tamil Nadu.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input id="lastName" type="text" required placeholder="Your last name" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-forest-500 focus:ring-2 focus:ring-forest-100 outline-none transition text-sm" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="email">Email Address *</label>
                <input id="email" type="email" required placeholder="you@example.com" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-forest-500 focus:ring-2 focus:ring-forest-100 outline-none transition text-sm" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="phone">Phone Number</label>
                <input id="phone" type="tel" placeholder="+91 XXXXX XXXXX" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-forest-500 focus:ring-2 focus:ring-forest-100 outline-none transition text-sm" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="city">City / Location</label>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">Prefer to reach us another way? Here is how to find RR Nursery in Thoothukudi.</p>
                  ...
                  <div key={cd.title} className="bg-forest-50 rounded-xl p-5 border border-forest-100">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-8 h-8 rounded-lg bg-forest-100 flex items-center justify-center">
                        <cd.icon className="w-4 h-4 text-forest-700" />
                      </div>
                      <h3 className="font-semibold text-gray-900 text-sm">{cd.title}</h3>
                    </div>
                    {cd.lines.map((line) => (
                      <p key={line} className="text-gray-600 text-sm pl-10">{line}</p>
                    ))}
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-2xl overflow-hidden border border-gray-200 bg-forest-50 h-64 flex flex-col items-center justify-center text-center p-8">
              <MapPin className="w-10 h-10 text-forest-400 mb-3" />
              <p className="font-semibold text-gray-800 mb-1">RR Nursery and Landscaping, Thoothukudi</p>
              <p className="text-sm text-gray-500">Tamil Nadu 628001, India</p>
              <p className="text-xs text-gray-400 mt-2">Embed your Google Maps iframe here once your real address is confirmed.</p>
            </div>
            ...
            <div className="bg-forest-800 text-white rounded-2xl p-6">
              ...
              <p className="text-forest-300 text-sm mb-4">
                Stay inspired with plant tips, South Tamil Nadu garden highlights, and behind-the-scenes nursery magic.
              </p>
              <div className="flex gap-3">
                {socialLinks.map(({ icon: Icon, label }) => (
                  <button key={label} aria-label={label} className="flex items-center gap-2 text-xs bg-forest-700 hover:bg-forest-600 transition-colors px-3 py-2 rounded-lg">
