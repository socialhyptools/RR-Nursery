...
const contactDetails = [
  { icon: MapPin, title: "Visit Us",       lines: ["123 Garden Lane", "Green Valley, CA 90210"] },
  { icon: Phone,  title: "Call Us",        lines: ["(123) 456-7890", "Mon–Sat: 8 AM – 6 PM"] },
  { icon: Mail,   title: "Email Us",       lines: ["info@rrnursery.com", "We reply within 24 hours"] },
...
const faqs = [
  { q: "Do you offer free consultations?",           a: "Yes! We offer a complimentary on-site or virtual consultation for all new customers. Our experts will assess your space and recommend the best service package." },
  ...
  { q: "Do you deliver plants?",                     a: "Yes, we deliver across the region. Delivery fees vary by distance. Orders above $200 qualify for free local delivery." },
  ...
  { q: "Do you work on commercial properties?",      a: "Absolutely. We serve restaurants, offices, apartment complexes, and retail spaces. Contact us to discuss your commercial landscaping needs." },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input id="firstName" type="text" required placeholder="Jane" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-forest-500 focus:ring-2 focus:ring-forest-100 outline-none transition text-sm" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="lastName">Last Name *</label>
                  <input id="lastName" type="text" required placeholder="Smith" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-forest-500 focus:ring-2 focus:ring-forest-100 outline-none transition text-sm" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="email">Email Address *</label>
                <input id="email" type="email" required placeholder="jane@example.com" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-forest-500 focus:ring-2 focus:ring-forest-100 outline-none transition text-sm" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="phone">Phone Number</label>
                <input id="phone" type="tel" placeholder="(123) 456-7890" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-forest-500 focus:ring-2 focus:ring-forest-100 outline-none transition text-sm" />
              </div>
              <div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">Prefer to reach us another way? Here is how to find us.</p>
            ...
            <div className="rounded-2xl overflow-hidden border border-gray-200 bg-forest-50 h-64 flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-sm text-gray-500">Embed your Google Maps iframe here once your real address is confirmed.</p>
            </div>
