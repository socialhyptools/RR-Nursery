...
const team = [
  { initials: "RR", name: "Rajesh R.",   role: "Founder & Master Horticulturist", bio: "With over 25 years in horticulture, Rajesh founded RR Nursery with a vision to make quality plants and professional landscaping accessible to everyone.", color: "bg-forest-700" },
  { initials: "RR", name: "Rekha R.",    role: "Co-Founder & Head of Design",     bio: "Rekha brings an artist's eye to every landscape design. She leads our creative team and personally oversees all major design projects.",              color: "bg-earth-600" },
  { initials: "AK", name: "Arun Kumar", role: "Lead Landscape Architect",         bio: "A certified landscape architect with a decade of experience, Arun specializes in sustainable design and water-efficient garden systems.",               color: "bg-forest-600" },
...
const values = [
  ...
  { icon: Users,    title: "Community Focus",              desc: "We actively participate in local greening initiatives, school garden programs, and urban reforestation projects." },
    ...
    <>
      ...
      <section className="bg-earth-50 border-y border-earth-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="section-subheading">Our values are not just words — they guide every project we take on.</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-12">
          ...
          <p className="section-subheading">The passionate people behind every beautiful garden we create.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member) => (
