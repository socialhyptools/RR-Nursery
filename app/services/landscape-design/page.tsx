...
const process = [
  {
    ...
    desc: "We visit your property to assess soil quality, sunlight exposure, drainage, existing vegetation, and your lifestyle needs. This forms the foundation of every design decision.",
  },
  {
    step: "02",
    title: "Concept Design",
    desc: "Our architects draft initial concept sketches covering zones — lawn, garden beds, pathways, water features, and utility areas — aligned with your vision and budget.",
  },
  {
    step: "03",
    title: "2D & 3D Rendering",
    desc: "We produce detailed 2D CAD plans and photorealistic 3D renders so you can walk through your future garden before a single spade hits the ground.",
  },
  {
    step: "04",
    title: "Material & Plant Selection",
    desc: "We help you select hardscape materials (stone, pavers, timber), plant species suited to your climate and soil, and irrigation components that save water long-term.",
  },
  {
    step: "05",
    title: "Installation & Project Management",
    desc: "Our experienced crew executes the plan with precision. Your dedicated project manager oversees every phase, keeps you updated, and ensures quality at every step.",
  },
  {
    step: "06",
    title: "Handover & Aftercare",
    desc: "Once complete, we walk you through your new landscape and provide a seasonal care guide. Optional maintenance packages keep your garden thriving year-round.",
  },
];
...
const faqs = [
  {
    ...
    a: "A typical residential project takes 2–4 weeks from initial consultation to final plan delivery. Complex or large-scale projects may take longer. We agree on a timeline upfront.",
  },
  {
    q: "What is included in the design fee?",
    a: "The design fee covers site visit, concept sketches, final 2D plan, and one revision round. 3D renders and full project management are available as add-ons or included in our premium packages.",
  },
  {
    q: "Do you manage the installation as well?",
    a: "Yes. We offer full turnkey services where we handle both design and installation. You can also take just the design plan and use your own contractor — we're flexible.",
  },
  {
    q: "Can you work within a tight budget?",
    a: "Absolutely. We design to the budget you set. We'll be transparent about what's achievable and help you prioritise so you get the most impact for your spend.",
  },
  {
    q: "Do you offer maintenance after installation?",
    a: "Yes — we offer optional monthly and seasonal maintenance contracts to keep your landscape looking its best long after installation.",
  },
];
